...
def parse_arguments(argv):
    ...
    parser.add_argument(
        "--source_domain", type=str, default="Art", help="Choose source domain."
    )

    parser.add_argument(
        "--target_domain", type=str, default="Real World", help="Choose target domain."
    )

    parser.add_argument(
        "--fig_mode", type=str, default=None, help="Plot experiment figures."
    )

    parser.add_argument(
        "--save_dir", type=str, default=None, help="Path to save plotted images."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="dann",
        help="Choose a mode to train the model.",
    )

    parser.add_argument(
        "--max_epoch", type=int, default=100, help="The max number of epochs."
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="Epoch number of plotting embeddings.",
    )
